...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/prices/master/_listings/aws-route-53/apis.md
...
- name: AWS Route 53 API - Create Hosted Zone
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/prices/master/_listings/aws-route-53/20130401hostedzone-post-openapi.md
- name: AWS Route 53 API - Create Hosted Zone
  x-api-slug: 20130401hostedzone-post
  description: Creates a new public hosted zone, used to specify how the Domain Name
    System (DNS)routes traffic on the Internet for a domain, such as example.com,
