...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/prices/master/_listings/eu-vat-api/apis.md
...
- name: VAT API - Convert a price to or from VAT price.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/prices/master/_listings/eu-vat-api/vatprice-get-openapi.md
- name: VAT API - Convert a price to or from VAT price.
  x-api-slug: vatprice-get
  description: Convert a price to or from vat price..
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/vatapi-logo.png
